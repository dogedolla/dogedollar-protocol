...
contract Account {
    ...
    struct State10 {
        uint256 depositedCDOGEDOLA;
        uint256 interestMultiplierEntry;
        uint256 earnableCDOGEDOLA;
        uint256 earnedCDOGEDOLA;
        uint256 redeemedCDOGEDOLA;
...
contract Storage {
    ...
    struct State10 {
        ...
        uint256 totalCDOGEDOLADeposited;
        uint256 totalCDOGEDOLAEarnable;
        uint256 totalCDOGEDOLAEarned;

        uint256 expansionStartEpoch;
        uint256 totalCDOGEDOLARedeemable;
        uint256 totalCDOGEDOLARedeemed;
    }

    struct State17 {
        Decimal.D256 CDOGEDOLAPrice;
        IOracle CDOGEDOLAOracle;
    }
}
