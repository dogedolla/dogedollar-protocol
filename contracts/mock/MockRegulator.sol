...
import "./MockCDOGEDOLAMarket.sol";
import "../oracle/IOracle.sol";
import "./MockState.sol";

contract MockRegulator is MockCDOGEDOLAMarket, Regulator {
    constructor(address oracle, address pool) public MockCDOGEDOLAMarket(pool) {
