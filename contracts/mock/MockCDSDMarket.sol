...
import "../dao/CDOGEDOLAMarket.sol";
import "./MockComptroller.sol";

contract MockCDOGEDOLAMarket is MockComptroller, CDOGEDOLAMarket {
    ...
    function justMintCDOGEDOLAToE(address account, uint256 amount) external {
