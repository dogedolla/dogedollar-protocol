...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    function initialize() initializer public {
        // committer reward:
        mintToAccount(msg.sender, 150e18); // 150 DOGEDOLA to committer
        // contributor  rewards:
        mintToAccount(0xF414CFf71eCC35320Df0BB577E3Bc9B69c9E1f07, 1000e18); // 1000 DOGEDOLA to devnull
        mintToAccount(0x35F32d099fb9E08b706A6fa41D639EEB69F8A906, 2000e18); // 2000 DOGEDOLA to degendegen9
    }
